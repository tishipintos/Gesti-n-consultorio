...
export function SelectField({ label, value, options, onChange, placeholder = 'Seleccioná una opción' }: { label: string; value: string; options: readonly { value: string; label: string; disabled?: boolean }[]; onChange: (value: string) => void; placeholder?: string }) {
  const [open, setOpen] = useState(false)
